...
const supabaseUrl = process.env.SUPABASE2_SUPABASE_URL || process.env.SUPABASE_URL || process.env.NEXT_PUBLIC_SUPABASE2_SUPABASE_URL || process.env.NEXT_PUBLIC_SUPABASE_URL || "";
